...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *L34BackendRef) DeepCopyInto(out *L34BackendRef) {
	*out = *in
	if in.Group != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new L34BackendRef.
func (in *L34BackendRef) DeepCopy() *L34BackendRef {
	if in == nil {
		return nil
	}
	out := new(L34BackendRef)
	in.DeepCopyInto(out)
	return out
}
